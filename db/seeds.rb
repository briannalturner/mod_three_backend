...
#   Character.create(name: 'Luke', movie: movies.first)
        ...
        #### USERS ####
bri = User.find_or_create_by!(first_name: "Bri", last_name: "Turner", username: "blt", password_digest: "bobross", age: 21)
joel = User.find_or_create_by!(first_name: "Joel", last_name: "McKay", username: "joely", password_digest: "bobross", age: 20)
jarrett = User.find_or_create_by!(first_name: "Jarrett", last_name: "McKay", username: "starwarsfan", password_digest: "bobross", age: 25)
robbie = User.find_or_create_by!(first_name: "Robbie", last_name: "Comer", username: "robcomer", password_digest: "bobross", age: 26)
devil = User.find_or_create_by!(first_name: "Lucy", last_name: "Furr", username: "theactualdevil", password_digest: "bobross", age: 10000)

...
sheila = User.find_or_create_by!(first_name: "Sheila", last_name: "McKay", username: "sheilam", password_digest: "bobross", age: 50, bio: "Mom of five. Reluctant high school business teacher.", image: "https://images.unsplash.com/photo-1493612276216-ee3925520721?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60https://images.unsplash.com/photo-1493612276216-ee3925520721?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
...
nice5 = Comment.find_or_create_by!(user: sheila, post: zumiez, body: "no")
...
nope = Comment.find_or_create_by!(user: robbie, post: starting, body: "Youtube is a good starting place, just don't put a lot of money into your gear until you know you like it")
...
like6 = PostLike.find_or_create_by!(user: sheila, post: zumiez)
...
like6 = CommentLike.find_or_create_by!(user: sheila, comment: nice5)
